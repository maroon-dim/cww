...
const routes = new Map([['/', ['index.html','text/html']], ['/index.html',['index.html','text/html']], ['/style.css',['style.css','text/css']], ...['app.js','geography.js','map-model.js','particles.js'].map(file=>['/'+file,[file,'text/javascript']])]);
